...
#     #(2300, 29000), (2600, 34000),
#     # (3000, 42000), (3500, 51000),
#     # (4000, 62000), (4500, 73000), (5000, 85000), (5500, 97000),
# ]
sizes = [
    (100, 3000), (200, 7000), (300, 13000), (400, 19000), (500, 26000),
    (600, 33000), (700, 40000), (800, 47000), (900, 54000), (1000, 62000),
    (1200, 70000), (1500, 79000),
    # (1800, 39000), (2000, 42000),
    #(2300, 29000), (2600, 34000),
    # (3000, 42000), (3500, 51000),
    # (4000, 62000), (4500, 73000), (5000, 85000), (5500, 97000),
]
